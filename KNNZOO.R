...
animals_pred<-knn(animals_train,animals_test,cl=animals_train_labels,k=15)
CrossTable(x = animals_test_labels, y = animals_pred,
           prop.chisq=FALSE)
confusionMatrix(table(animals_pred,animals_test_labels)) 

animals_pred<-knn(animals_train,animals_test,cl=animals_train_labels,k=4)
CrossTable(x = animals_test_labels, y = animals_pred,
           prop.chisq=FALSE)
confusionMatrix(table(animals_pred,animals_test_labels)) 


animals_pred<-knn(animals_train,animals_test,cl=animals_train_labels,k=19)
CrossTable(x = animals_test_labels, y = animals_pred,
           prop.chisq=FALSE)
confusionMatrix(table(animals_pred,animals_test_labels)) 
